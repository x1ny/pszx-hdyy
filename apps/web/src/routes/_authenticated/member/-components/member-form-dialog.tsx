...
const MemberFormSchema = z
  .object({
    ...
    mobile: z
      ...
      .trim()
      .max(20, "手机号过长")
      .refine((value) => !value || /^1\d{10}$/.test(value), "请输入正确的手机号")
      .optional(),
    phone: z
      .string()
      .trim()
    ...
    >
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <form.Field name="gender">
          {(field) => (
            <Field>
              ...
              >
                <SelectTrigger className="w-full" aria-invalid={hasError(field)}>
          ...
          {(field) => (
            <Field>
              ...
              <Select
                ...
                value={field.state.value}
                onValueChange={(value) => {
                  if (value) field.handleChange(value as MemberFormState["status"]);
                  field.handleBlur();
                }}
              >
        ...
        <form.Field name="mobile">
          {(field) => (
            <TextField field={field} label="手机号" placeholder="请输入手机号" />
          )}
        </form.Field>

        <form.Field name="phone">
          {(field) => (
            <TextField field={field} label="电话" placeholder="请输入电话，如 010-12345678" />
          )}
        </form.Field>
